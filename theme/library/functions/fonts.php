<?php
/**
 * Enqueue Google Fonts for Parasole theme.
 */
function pstroot_google_fonts() {
...
add_action( 'wp_enqueue_scripts', 'pstroot_google_fonts' );
add_action('admin_init', 'pstroot_google_fonts');
