...
if ( $buttons ) :
  if(count($buttons) == 1){
    ...
    $button_markup .= '<select class="cta-button border-2 border-primary mx-0 py-[3.2px] dark:bg-base-300!" name="restaurantsMenu" aria-label="Select a restaurant" id="restaurantsMenuSelection" onchange="MM_jumpMenu(\'_blank\',this,0)"><option value="">Make a Reservation</option>';
